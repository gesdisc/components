...
loadTimeSeries_fn = async function(signal) {
  ...
  console.log(
    ...
    isDateRangeContained(
      startDate,
      endDate,
      new Date(existingTerraData == null ? void 0 : existingTerraData.startDate),
      new Date(existingTerraData == null ? void 0 : existingTerraData.endDate)
    )
  );
  console.log("Is cache valid?", __privateMethod(this, _isCacheValid, isCacheValid_fn).call(this, existingTerraData));
...
isCacheValid_fn = function(existingData) {
  if (!(existingData == null ? void 0 : existingData.cachedAt)) {
