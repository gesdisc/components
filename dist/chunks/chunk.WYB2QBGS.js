...
var TerraDatePicker = class extends TerraElement {
  ...
  firstUpdated() {
    ...
    const formatToDate = (dateStr) => dateStr ? new Date(dateStr).toISOString().split("T")[0] : void 0;
    this.startDate = formatToDate(timeStartParam);
    this.endDate = formatToDate(timeEndParam);
    this.selectedDates = {
      startDate: (_a = this.startDate) != null ? _a : null,
      endDate: this.range ? (_b = this.endDate) != null ? _b : null : null
    };
  ...
  handleChange(selectedDates) {
    ...
    const timeStartISO = (_c = selectedDates[0]) == null ? void 0 : _c.toISOString();
    const timeEndISO = this.range ? (_d = selectedDates[1]) == null ? void 0 : _d.toISOString() : void 0;
    if (timeStartISO) {
