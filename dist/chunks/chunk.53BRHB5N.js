    ...
    this.jobStatusTask = new h(host, {
      task: async ([], { signal }) => {
        ...
        let subsetOptions = {
          ...
          variableEntryIds: [`${__privateGet(this, _host).collection}_${__privateGet(this, _host).variable}`],
        ...
        try {
          ...
          const { blob } = await __privateGet(this, _dataService).getSubsetJobData(jobStatus, {
            signal,
            bearerToken: __privateGet(this, _host).bearerToken
          });
          this.blobUrl = blob;
