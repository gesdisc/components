import {
  ...
  getDataByKey
} from "./chunk.5KOP2B3E.js";
import {
  time_series_styles_default
} from "./chunk.SIOVEWZT.js";
import {
  TerraPlot,
  require_plotly_min
} from "./chunk.TZU3U7IW.js";
import {
  AuthController
...
timeseries`,
      ...
      jupyterWindow.postMessage(
        {
          type: "load-notebook",
          filename: `${encodeURIComponent((_a = this.getVariableEntryId()) != null ? _a : "plot")}.ipynb`,
          notebook,
          timeSeriesData,
