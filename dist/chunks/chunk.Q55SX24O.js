...
} from "./chunk.CB3TQ7EM.js";
import {
  h
} from "./chunk.EMLDT66I.js";
import {
  TerraButton
} from "./chunk.7YGYIH7I.js";
import {
  TerraIcon
} from "./chunk.DWB4WJKI.js";
import {
  watch
...
var _handleActiveMenuItem, handleActiveMenuItem_fn, _handleMenuLeave, handleMenuLeave_fn, _onShowOpacityChange, _onColorMapChange, _renderGeotiffPanel, renderGeotiffPanel_fn, _renderInfoPanel, renderInfoPanel_fn, _renderDownloadPanel, renderDownloadPanel_fn, _renderHelpPanel, renderHelpPanel_fn, _renderJupyterNotebookPanel, renderJupyterNotebookPanel_fn, _handleJupyterNotebookClick, handleJupyterNotebookClick_fn, _downloadPNG, downloadPNG_fn, _downloadCSV, downloadCSV_fn, _convertToCSV, convertToCSV_fn, _downloadGeotiff, downloadGeotiff_fn;
var TerraPlotToolbar = class extends TerraElement {
  constructor() {
    super(...arguments);
    __privateAdd(this, _handleActiveMenuItem);
    __privateAdd(this, _handleMenuLeave);
    __privateAdd(this, _renderGeotiffPanel);
    ...
    this.colorMapName = "density";
    __privateAdd(this, _onShowOpacityChange, (e2) => {
      this.opacity = parseFloat(e2.target.value);
    ...
    __privateAdd(this, _onColorMapChange, (e2) => {
      this.colorMapName = e2.target.value;
    ...
    return h(
      !this.catalogVariable ? x`<div class="spacer"></div>` : x` <header>
                      ...
                      >
                          ...
                          >
                              ${__privateMethod(this, _renderGeotiffPanel, renderGeotiffPanel_fn).call(this)}
                          </li>
                      </menu>
                  </header>`
    );
...
_onShowOpacityChange = new WeakMap();
_onColorMapChange = new WeakMap();
_renderGeotiffPanel = new WeakSet();
renderGeotiffPanel_fn = function() {
  return x`
          ...
          ${this.dataType === "geotiff" ? x`
            ...
            <label>
                ...
                @change=${__privateGet(this, _onShowOpacityChange)}
                />
            ...
            <label>
                ColorMap:
                <select id="colormap-select" @change=${__privateGet(this, _onColorMapChange)}>
                    ${this.colormaps.map((cm) => x`
...
__decorateClass([
  n({ type: String })
], TerraPlotToolbar.prototype, "colormap", 2);
__decorateClass([
  n({ type: Number })
], TerraPlotToolbar.prototype, "opacity", 2);
__decorateClass([
  n()
], TerraPlotToolbar.prototype, "pixelValue", 2);
__decorateClass([
  n()
], TerraPlotToolbar.prototype, "pixelCoordinates", 2);
__decorateClass([
  r()
], TerraPlotToolbar.prototype, "activeMenuItem", 2);
__decorateClass([
  r()
], TerraPlotToolbar.prototype, "colormaps", 2);
__decorateClass([
  r()
], TerraPlotToolbar.prototype, "colorMapName", 2);
__decorateClass([
  e("#menu")
