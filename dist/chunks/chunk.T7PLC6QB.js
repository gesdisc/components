...
var _host, _dataService, _updateGeoTIFFLayer, updateGeoTIFFLayer_fn, _waitForHarmonyJob, waitForHarmonyJob_fn, _getDataService, getDataService_fn, _getEmptyJob, getEmptyJob_fn;
var TimeAvgMapController = class {
  constructor(host) {
    __privateAdd(this, _updateGeoTIFFLayer);
      ...
      task: async ([], { signal }) => {
        ...
        try {
          ...
          if (existing) {
            ...
            __privateMethod(this, _updateGeoTIFFLayer, updateGeoTIFFLayer_fn).call(this, existing.blob);
          ...
          __privateMethod(this, _updateGeoTIFFLayer, updateGeoTIFFLayer_fn).call(this, blob);
          return blob;
        } catch (err) {
...
_updateGeoTIFFLayer = new WeakSet();
updateGeoTIFFLayer_fn = function(blob) {
  this.blobUrl = blob;
  ...
  __privateGet(this, _host).updateGeoTIFFLayer(blob);
};
