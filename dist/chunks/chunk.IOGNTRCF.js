...
} from "./chunk.2DYHCVKO.js";
import {
  getNotebook
} from "./chunk.E4O4FZ2X.js";
import {
  TerraLogin
} from "./chunk.6GKYJ4O5.js";
import {
  TerraDatePicker
...
init_buffer();
init_process();
var JUPYTER_LITE_URL = "https://gesdisc.github.io/jupyterlite/lab/index.html";
function openJupyterLiteWindow(readyCb) {
...
function sendDataToJupyterNotebook(type, data) {
  openJupyterLiteWindow((event, jupyterWindow) => {
    ...
    jupyterWindow.postMessage(__spreadValues({ type }, data), "*");
  });
}
...
var TerraDataSubsetter = class extends TerraElement {
  constructor() {
    ...
    __privateAdd(this, _handleSpatialChange, (e2) => {
      ...
      if (e2.detail.type === "bbox" /* BBOX */) {
        this.spatialSelection = {
          e: round2(e2.detail.bounds.getNorthEast().lng),
          n: round2(e2.detail.bounds.getNorthEast().lat),
          w: round2(e2.detail.bounds.getSouthWest().lng),
          s: round2(e2.detail.bounds.getSouthWest().lat)
        };
      } else if (e2.detail.type === "point" /* POINT */) {
...
renderSubsetOptions_fn = function() {
  ...
  if (__privateGet(this, _controller).fetchCollectionTask.status === s.PENDING) {
    return x`<terra-loader indeterminate></terra-loader>`;
  }
  return x`
  ...
  return x`
            <terra-accordion .open=${this.collectionAccordionOpen}>
                ...
                <div class="search-container-mini">
                    <input
                        ...
                        @input="${(e2) => this.handleCollectionSearch(
    e2.target.value
  )}"
                    />
                ...
                <div id="search-results-section" class="search-results-section">
                    ${this.collectionSearchLoading ? x`
                              <div id="loading-mini" class="loading-mini">
                                  <div class="spinner-mini"></div>
                                  <div>Searching NASA CMR...</div>
                              </div>
                          ` : ((_a = this.collectionSearchResults) == null ? void 0 : _a.length) ? x` <div
    ...
    (item) => x`
      ...
      this.requestUpdate();
                            ...
                            </div>` : this.collectionSearchResults && this.collectionSearchResults.length === 0 ? x`<div id="no-results-mini" class="no-results-mini">
                                  <p>
...
handleJupyterNotebookClick_fn = function() {
  ...
  sendDataToJupyterNotebook("load-notebook", {
    filename: `subset_${(_a = __privateGet(this, _controller).currentJob) == null ? void 0 : _a.jobID}.ipynb`,
    notebook,
...
__decorateClass([
  n({ reflect: true, type: Boolean, attribute: "show-history-panel" })
], TerraDataSubsetter.prototype, "showHistoryPanel", 2);
__decorateClass([
